...
public class Level2GUI extends JFrame{
    ...
    public Level2GUI(){
        ...
        final JLabel backgroundLabel = page.bgLabel("src/assets/maze2.png");
        add(backgroundLabel);
...
//                        }else if (player.getY() > 300 && (player.getX() < 70 || player.getX() > 660)){//Kiri kanan bawah
//                            player.setY(player.getY() - 10);
//                        }else if (player.getY() < 370 && player.getY() > 300 && ((player.getX() > 60 && player.getX() < 130) || (player.getX() > 610 && player.getX() < 670))){
//                            player.setY(player.getY() - 10);
//                        }else if (player.getY() < 370 && player.getY() > 150 && player.getX() > 120 && player.getX() < 620){
//                            player.setY(player.getY() - 10);
//                        }else if (player.getY() > 150 && player.getY() < 220 && ((player.getX() < 130 && player.getX() > 60) || (player.getX() < 670 && player.getX() > 610))){
//                            player.setY(player.getY() - 10);
//                        }else if (player.getY() < 220 && player.getY() > 10 && (player.getX() > 660 || player.getX() < 70)){
//                            player.setY(player.getY() - 10);
...
//                            player.setY(player.getY() + 10);
//                        }else if (player.getY() < 500 && player.getY() > 290 && (player.getX() < 70 || player.getX() > 660)){
//                            player.setY(player.getY() + 10);
//                        }else if (player.getY() < 360 && player.getY() > 290 && ((player.getX() > 60 && player.getX() < 130) || (player.getX() > 610 && player.getX() < 670))){
//                            player.setY(player.getY() + 10);
//                        }else if (player.getY() < 360 && player.getY() > 140 && player.getX() > 120 && player.getX() < 620){
//                            player.setY(player.getY() + 10);
//                        }else if (player.getY() > 140 && player.getY() < 210 && ((player.getX() < 130 && player.getX() > 60) || (player.getX() == 700))){
//                            player.setY(player.getY() + 10);
//                        }else if (player.getY() < 210 && player.getY() > 10 && (player.getX() == 700 || player.getX() < 70)){
//                            player.setY(player.getY() + 10);
...
//                                if (player.getY() > 290){
//                                    player.setX(player.getX() + 10);
//                                }else if (player.getY() > 210 && player.getX() < 610){
//                                    player.setX(player.getX() + 10);
//                                }else if (player.getY() <= 210 && player.getX() < 610){
//                                    player.setX(player.getX() + 10);
//                                }
//                            }else if (player.getX() < 320 && player.getY() > 70){//Sisi kiri
//                                if (player.getY() > 360 && player.getX() < 60){
//                                    player.setX(player.getX() + 10);
//                                }else if (player.getY() > 140 && player.getY() < 370){
//                                    player.setX(player.getX() + 10);
