                ...
                switch (keyCode){
                    ...
                    case KeyEvent.VK_W :
                        if (player.getY() > 460){//Bawah
                            ...
                            player.setY(player.getY() - 10);
                        }else if (player.getY() > 180 && player.getY() < 220 && ((player.getX() < 130 && player.getX() > 60) || (player.getX() < 670 && player.getX() > 610))){
                            player.setY(player.getY() - 10);
                        }else if (player.getY() < 220 && player.getY() > 40 && (player.getX() > 660 || player.getX() < 70)){
                            player.setY(player.getY() - 10);
                    ...
                    case KeyEvent.VK_S:
                        if (player.getY() >= 440 && player.getY() < 520){
                            ...
                            player.setY(player.getY() + 10);
                        }else if (player.getY() > 140 && player.getY() < 210 && ((player.getX() < 130 && player.getX() > 60) || (player.getX() < 670 && player.getX() > 610))){
                            player.setY(player.getY() + 10);
                        }else if (player.getY() < 210 && player.getY() > 10 && (player.getX() > 660 || player.getX() < 70)){
                            player.setY(player.getY() + 10);
